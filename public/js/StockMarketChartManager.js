	...
	attachHoveringEffect:function(){
		...
		.on("mousemove",function(){
			...
			updateChartWithData:function(){
				...
				var cmfConfigurations=JSON.parse(JSON.stringify(HistoricalDataChart.cmfConfigurations));
				var lineChartConfiguration=JSON.parse(JSON.stringify(HistoricalDataChart.lineChartConfiguration));
				var powerGauageChartConfiguration=JSON.parse(JSON.stringify(HistoricalDataChart.powerGauageChartConfiguration));
